...
function Login() {
    return (
        <div className="min-h-screen px-10 flex items-center">
            ...
            <button className="container focus:ring focus:ring-blue-600 hover:bg-blue-500 transition-all outline-none mt-6 bg-blue-400 py-2 font-semibold text-white uppercase rounded">Login</button>
            </div>
        </div>
